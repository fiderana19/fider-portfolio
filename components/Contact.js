        ...
        <div className={`${General.page}`}>
            <div className={`my-12`}>
                ...
                <div className="lg:flex block gap-3">
                        <Link href={`https://www.linkedin.com/fiderana-antsa-andriaherilanto/`} target="_blank" rel="noopener noreferrer" className="lg:w-1/3 w-full group transition-colors relative hover:bg-darklg flex items-center p-1 my-4 border border-opacity-25  border-gray-600 bg-darkmd rounded">
                            <div className="relative text-black">
                                <Image src={Img} width={45} height={45} alt="Profile pic" className="rounded-full" />
                        ...
                        <Link href={`https://x.com/FideranaAntsa1`} target="_blank" rel="noopener noreferrer" className="lg:w-1/3 w-full relative group transition-colors hover:bg-darklg flex items-center p-1 my-4 border border-gray-600 bg-darkmd border-opacity-25  rounded">
                            <div className="relative text-black">
                                <Image src={Img} width={45} alt="Profile pic" height={45} className="rounded-full" />
                        ...
                        <Link href={`mailto:antsafider@gmail.com`} target="_blank" rel="noopener noreferrer" className="lg:w-1/3 w-full relative transition-colors group hover:bg-darklg flex items-center p-1 my-4 border border-gray-600 bg-darkmd border-opacity-25  rounded">
                            <div className="relative text-black">
                                <Image src={Img} width={45} alt="Profile pic" height={45} className="rounded-full" />
                                <Image src={MailIcon} alt="Mail icon" className="rounded-full w-4 h-auto absolute right-0 bottom-0" />
                            </div>
                            <div className="items-center ml-4">
