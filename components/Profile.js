    ...
    return(
        <div className={`${General.page} md:flex block justify-between h-full items-center`}>
            <div className="flex-[2] md:my-16 md:py-0 pt-32 ">
                ...
                <div className="text-2xl my-4 font-medium text-bluecolor">Full-stack JavaScript Developper</div>
                <div className="text-md text-gray-400">I'm a Full-stack JavaScript Developper(ReactJS, NestJS, TypeScript) !
                Living in 
                ...
                <Link href={`/pdf/cv-fiderana.pdf`} download className="flex w-max">
