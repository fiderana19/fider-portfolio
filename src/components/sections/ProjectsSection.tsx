...
function ExpandedProject({ project }: { project: Project }) {
  return (
    ...
    >
      <div className="border-t border-zinc-800 pb-6 pl-6 pr-6 pt-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {project.githubFrontend && (
            <Button href={project.githubFrontend} variant="secondary" size="sm">
              Frontend Repo
            </Button>
          )}
          {project.githubBackend && (
            <Button href={project.githubBackend} variant="secondary" size="sm">
              Backend Repo
            </Button>
          )}
          {project.demo && (
      ...
      <div className="mx-auto max-w-5xl px-4 py-20">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project) => (
            <div key={project.slug} className="overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900">
